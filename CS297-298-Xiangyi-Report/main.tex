...
\begin{table}[h]
\centering
\caption{Comprehensive comparison of existing emotion detection approaches in literature}
\label{tab:literature_comparison}
\resizebox{\textwidth}{!}{%
\begin{tabular}{|p{0.8cm}|p{2.8cm}|p{4.5cm}|p{2.8cm}|p{3.5cm}|p{1.5cm}|p{1.5cm}|}
\hline
\textbf{Ref.} & \textbf{Dataset} & \textbf{Features} & \textbf{Modality} & \textbf{Classification Method} & \textbf{Metrics} & \textbf{Score} \\
\hline
\cite{mohammad2013crowdsourcing} & Twitter corpus & Lexicon-based, emotional word counts, n-grams & Text & Supervised learning, SVM & Accuracy & 65.12\% \\
\hline
\cite{wang2012harnessing} & Movie reviews, product reviews & Syntax patterns, part-of-speech features, dependency relations & Text & SVM with tree kernels & F1 & 67.84\% \\
\hline
\cite{abdul2017emonet} & ISEAR, SemEval & Word embeddings, recurrent features & Text & BiLSTM with attention & Accuracy & 72.08\% \\
\hline
\cite{devlin2018bert} & MultiNLI, GLUE & Contextual embeddings, self-attention & Text & Fine-tuned BERT & Accuracy & 86.7\% \\
\hline
\cite{liu2019roberta} & NLP benchmarks & Dynamic token masking, larger batch training & Text & Fine-tuned RoBERTa & Accuracy & 88.1\% \\
\hline
\cite{schuller2009acoustic} & FAU Aibo Emotion Corpus & 384 LLDs, energy, pitch, formants, MFCCs & Audio & SVM, Hidden Markov Models & UAR & 70.29\% \\
\hline
\cite{li2013speech} & Chinese emotional speech corpus & MFCCs, pitch, formants, energy & Audio & SVM, Decision Trees & Accuracy & 76.4\% \\
\hline
\cite{mao2014learning} & Mandarin emotional database & Raw spectrograms, MFCCs & Audio & CNN, LSTM & Accuracy & 81.9\% \\
\hline
\cite{schneider2019wav2vec} & LibriSpeech & Self-supervised wave embeddings & Audio & Wav2vec + fine-tuning & WER & 6.92\% \\
\hline
\cite{poria2017review} & IEMOCAP, SEMAINE & Text embeddings, audio-visual features & Multimodal & Early fusion, CNN-LSTM & Accuracy & 76.1\% \\
\hline
\cite{wagner2011introducting} & GEMEP corpus & Acoustic features, visual action units & Multimodal & Late fusion, SVM ensemble & UAR & 73.4\% \\
\hline
