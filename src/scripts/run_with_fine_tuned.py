...
def main():
    ...
    from data.data_loader import load_iemocap_data, scale_vad_values, get_emotion_mapping
    ...
    from utils.visualization import plot_confusion_matrix, plot_vad_distribution, plot_vad_by_emotion, plot_tsne_vad
